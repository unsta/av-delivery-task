...
readonly class ReportService
{
    ...
    public function generateReport(): ReportResource
    {
        ...
        $drivers = $drivers->map(function ($driver) use ($restaurants) {
            $driver->closestRestaurant = $this->driverDistanceService
                ->closestRestaurant($driver, $restaurants);

            $driver->distanceToAssigned = $this->driverDistanceService
                ->distanceToRestaurant($driver, $driver->nextRestaurant);

            $driver->distanceToClosest = $this->driverDistanceService
                ->distanceToRestaurant($driver, $driver->closestRestaurant);
